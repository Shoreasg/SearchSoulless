        ...
        <>
            {firstSoullessData && secondSoullessData ?
                <>
                    <div className="py-10 max-w-screen">
                        <header>
                            ...
                            <main className="h-fit w-max md:w-screen flex flex-row justify-center">
                ...
                <div className="py-10 max-w-screen">
                    <header>
                        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                            <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Compare</h1>
                        </div>
                    </header>
